...
<div class="box" id="main">
    ...
    <div class="stopbtn waves-light js-stop" style="font-family:Copperplate; color: white;" onclick="load_progress()" id="stoprec"></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br><h1>Stop & Identify</h1></div>
		...
		<p style="color:#FFFFFF; font-family:Copperplate">It might take up to 90 seconds to match the track.</br></br>If you wish to submit a known track to the database,</br>
		<p style="color:#FFFFFF; font-family:Copperplate">Feel free to email <b><a href="mailto:music@bboyzone.org" style="color:#FFFFFF; font-family:Copperplate">music@bboyzone.org</a></b> with the name of the track.</br>
		<p style="color:#FFFFFF; font-family:Copperplate">Any contribution would be greatly appriciated!</br>
</div>
</body>
</html>
